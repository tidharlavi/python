...
def extract_load_crawl(url_info_dic):
    ...
    print "start extract_load_crawl(): Going to ext.extract_info()."
    ...
    print "start extract_load_crawl(): ldr.load_image_details_array()."
    ...
    print "start extract_load_crawl(): crlr.insert_urls()."
