...
class GReverseImageSearch(object):
    '''
    classdocs
    '''
    ...
    def search(self, image_url=None, image_path=None, g_page_results_max = 20):
        
        if not image_url and not image_path:
            print("GReverseImageSearch.search(): No image !!!")
            return
        ...
        print "GReverseImageSearch.search(): driver.get({0})".format(url)
        driver.get(url);
